...
export default function Footer() {
  return (
    <>
      <div className="sm:p-14 p-2 bg-black text-sky-600 font-display relative">
        <div className="flex flex-wrap sm:justify-between items-center justify-center w-full gap-2 py-5">
          <div className="flex flex-col justify-between h-[200px] flex-grow mb-10">
          ...
          <div className="flex flex-col justify-between sm:items-start items-center h-[250px] flex-grow mb-10">
            <div className="flex items-center">
