  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full">
        <span className="text-xl font-display mb-4 relative after:absolute after:w-[100%] after:h-[3px] after:bg-white after:bottom-0 after:left-[0px] after:m-auto pb-1">
          Explore recent Works
        </span>
        <h1 className="text-4xl font-head">Featured Projects</h1>
        <div className="flex justify-between font-display w-full flex-wrap gap-5 p-4">
          <div className="items bg-white flex justify-between flex-col lg:h-full w-[300px] shadow-lg shadow-black sm:p-7 p-4 hover:text-sky-600 transition-colors delay-100 ease-in flex-grow border-2 gap-4 ">
          ...
          <div className="items bg-white flex justify-between flex-col lg:h-full w-[300px] shadow-lg shadow-black sm:p-7 p-4 hover:text-sky-600 transition-colors delay-100 ease-in flex-grow border-2 gap-2 ">
