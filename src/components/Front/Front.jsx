...
export default function Front() {
  ...
  return (
    <motion.div initial="hidden" animate="visible">
      ...
      <motion.div
        variants={container}
        className="flex flex-wrap justify-between sm:mx-10 m-4 font-display z-10 relative h-[450px] items-center sm:mt-aut0 mt-[50px] mb-28"
      >
        <motion.div
          variants={item}
          className="company-des w-[60%] sm:p-4 flex-grow"
        >
          <div className="flex flex-col justify-between lg:h-[15rem] h-auto text-white">
            ...
            <motion.button
              ...
              className="mt-6 w-[125px] bg-black hover:bg-blue-700 text-blue-600 hover:text-black hover:font-bold py-2 px-4 rounded "
            >
        ...
        <motion.div
          variants={item1}
          className="lg:w-[400px] xl:flex hidden md:mt-[80px] sm:w-[60%] w-[100%] mx-auto mt-[140px] p-[20px] shadow-2xl shadow-black bg-white rounded-md"
        >
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <motion.button
              animate={{ scale: 1.2 }}
              transition={{ type: "spring", damping: 3 }}
              className="flex justify-between items-center mt-6 w-[120px] bg-black hover:bg-blue-700 text-blue-600 hover:text-black hover:font-bold py-2 px-4 rounded "
            >
              Explore
              <AiOutlineArrowRight />
            </motion.button>
